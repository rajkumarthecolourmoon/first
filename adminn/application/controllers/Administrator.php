<?php 
	class Administrator extends CI_Controller{
		...
		public function dashboard($page = 'dashboard'){
		   ...
		   $data['count_users'] = $this->Administrator_Model->users_count();
		  // print_r($data['count_users']);die();
		  // $data['title'] = ucfirst($page);
		   $this->load->view('administrator/header-script');
		   $this->load->view('administrator/header');
		   $this->load->view('administrator/header-bottom');
	...
	public function multipleImageUpload($images,$dataID){
		...
		public function faq_categories()
		{
			...
			//echo "<pre>"; print_r($data['faq_categories']);die();
		...
		public function get_admin_data()
		{
			...
			// print_r($data['changePassword']);die();

                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <?php foreach($listBlogComments as $comment) : ?>
                                 <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>administrator/blogs/view-comment/<?php echo $comment['commentId']; ?>"><?php echo substr($comment['blogTitle'],0,7); ?>...</a>
                                        </td>
                                        <td>
                                         ...
                                         <td>
                                            <a href="<?php echo base_url(); ?>administrator/blogs/view-comment/<?php echo $comment['commentId']; ?>"><?php echo substr($comment['comment'],0,15); ?>...
                                            </a>
                                        </td>
                                         <td>
                                            <?php echo date("M d,Y H:i:s", strtotime($comment['createdAt'])); ?>
